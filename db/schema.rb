...
ActiveRecord::Schema.define(version: 20_190_516_230_712) do
  ...
  create_table 'friendships', force: :cascade do |t|
    ...
    t.index %w[user_id friended_user_id], name: 'index_friendships_on_user_id_and_friended_user_id', unique: true
